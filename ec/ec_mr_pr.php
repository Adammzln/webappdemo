                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Enactus <small>Project Report</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-edit"></i> Mandatory Report  <i class="fa fa-chevron-circle-right"></i> PR
                            </li>
                        </ol>
                    </div>
                </div>
           
<form class="form-horizontal" role="form" action="ec_mr_pr.php" method="post">
