            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-check-square"></i> Participants Application <i class="fa fa-chevron-circle-right"></i> Competition Team
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-10">
                        <div class="div">
<form class="form-horizontal" role="form" action="ec_pa_ct.php" method="post">

		<div class="form-group">
            <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>As competing teams, you will receive free 10 goodie bags</h3>
            </div>
