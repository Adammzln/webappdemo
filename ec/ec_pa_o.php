                    ...
                    <div class="col-lg-10">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Observer</h3>
                            </div>
                            <div class="div">
<form class="form-horizontal" role="form" action="ec_pa_o.php" method="post">
