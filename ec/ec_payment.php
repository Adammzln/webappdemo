  ...
  <?php include 'nav_ec.php'?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <div class="panel-heading">
                              <form class="form-horizontal" role="form" action="ec_payment.php" method="post">
		...
		<input type="hidden" name="add_participant" value="true">
                ...
                <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-trophy"></i> Payment 
                        </ol>
						<div class="row">
						<div><img src="<?php echo $path . $img ?>" alt="" height="420" width="840"/></div>
						</div>
